...
isConditionTrue_0 = gdjs.playerAuthentication.isAuthenticated();
if (isConditionTrue_0) {
{gdjs.evtTools.leaderboards.saveConnectedPlayerScore(runtimeScene, "a41abfc9-2392-4fda-a2eb-abcf16b5c0d6", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Score")));
}}
...
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "a41abfc9-2392-4fda-a2eb-abcf16b5c0d6", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().get("Score")), (( gdjs.LeaderboardCode.GDPlayerNameInputObjects2.length === 0 ) ? "" :gdjs.LeaderboardCode.GDPlayerNameInputObjects2[0].getString()));
...
}{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "a41abfc9-2392-4fda-a2eb-abcf16b5c0d6", true);
}}
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.LeaderboardCode.mapOfGDgdjs_9546LeaderboardCode_9546GDCoinObjects3Objects, gdjs.randomInRange(gdjs.evtTools.camera.getCameraBorderLeft(runtimeScene, "", 0), gdjs.evtTools.camera.getCameraBorderRight(runtimeScene, "", 0)), gdjs.randomInRange(-(500) + gdjs.evtTools.camera.getCameraBorderTop(runtimeScene, "", 0), gdjs.evtTools.camera.getCameraBorderBottom(runtimeScene, "", 0) + 500), "3D");
    ...
    gdjs.LeaderboardCode.GDCoinObjects3[i].setZ(gdjs.randomFloatInRange(-(1000), -(32)));
}
}{for(var i = 0, len = gdjs.LeaderboardCode.GDCoinObjects3.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDCoinObjects3[i].setRotationX(gdjs.LeaderboardCode.GDCoinObjects3[i].getRotationX() + (gdjs.randomFloat(360)));
}
}{for(var i = 0, len = gdjs.LeaderboardCode.GDCoinObjects3.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDCoinObjects3[i].setRotationY(gdjs.LeaderboardCode.GDCoinObjects3[i].getRotationY() + (gdjs.randomFloat(360)));
}
}}
}
...
{for(var i = 0, len = gdjs.LeaderboardCode.GDCoinObjects1.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDCoinObjects1[i].setRotationX(gdjs.LeaderboardCode.GDCoinObjects1[i].getRotationX() + ((gdjs.RuntimeObject.getVariableNumber(gdjs.LeaderboardCode.GDCoinObjects1[i].getVariables().get("RotationX"))) * gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}{for(var i = 0, len = gdjs.LeaderboardCode.GDCoinObjects1.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDCoinObjects1[i].setRotationY(gdjs.LeaderboardCode.GDCoinObjects1[i].getRotationY() + ((gdjs.RuntimeObject.getVariableNumber(gdjs.LeaderboardCode.GDCoinObjects1[i].getVariables().get("RotationY"))) * gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}{for(var i = 0, len = gdjs.LeaderboardCode.GDCoinObjects1.length ;i < len;++i) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.leaderboards.hasBeenSaved("a41abfc9-2392-4fda-a2eb-abcf16b5c0d6");
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Game", false);
}}
