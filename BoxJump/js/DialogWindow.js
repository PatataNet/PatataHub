	...
	function DialogWindow() {
        ...
        this.createDialogWindow = function(state){
            ...
            if (state == "pause"){ //menu dialog
                this.text_1.text = "";
                this.text_2.text = "";
                this.text_2.text = "Skins";
                this.text_1.y = this.box * 6;
                this.text_2.y = this.box * 8;
                this.button_1.setText('Salir');
                this.button_2.setText('Continuar');
                ...
                this.button_1.y += this.box * 5;
                this.button_2.y += this.box * 5;
                this.button_1.setText('Reintentar nivel');
                this.button_2.setText('Continuar');
                ...
                if (window.Game.prevView == 1){
                    if (parsedGameScore < parsedStorageScore || parsedStorageScore == 0){
                        ...
                        this.text_2.text = "Nuevo record Record!";
                    }
                    else { 
                        this.text_1.text = "Terminado!"; 
                        this.text_2.text = "Record - "+storageScore;
                    }
                    window.storageManager.unlockLevelSkin(level);
                }
                else {
                    this.text_1.text = window.Game.score; 
                    this.text_2.text = "Buen trabajo!";
                }
                ...
                this.text_1.text = "Has ganado!";
                this.text_2.text = "Prueba tambien el juego original o espera nuevas actualizaciones!";
                this.text_1.y = this.box * 6;
                this.text_2.y = this.box * 8;
                this.button_2.setText('Continuar');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_2); //exclude button_1
                ...
                this.button_1.setText('Eliminar');
                this.button_2.setText('Cancelar');
                this.dialog.addChild(this.bg, this.button_1, this.button_2); //exclude text
            }
            else if (state == "shareCode"){ //share code
                this.text_1.text = "Subiendo";
                this.text_2.text = "Espera.";
                this.text_1.y = this.box * 6;
                this.text_2.y = this.box * 8;
                this.button_2.setText('Cancelar');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_2); //exclude button_1
                ...
                this.text_2.text = "Se ha generado el codigo de tu nivel.";
                this.text_1.y = this.box * 4;
                this.text_2.y = this.box * 6;
                this.button_1.setText('Copiar');
                this.button_2.setText('Cerrar');
                ...
                this.text_1.text = "Error de red";
                this.text_2.text = "Checa tu conexion a internet.";
                this.text_1.y = this.box * 4;
                this.text_2.y = this.box * 6;
                this.button_1.setText('Cerrar');
                this.button_2.setText('Reintentar');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_1, this.button_2); //exclude button_1
            }
            else if (state == "downloadOptions"){  //play code
                this.text_1.text = "Descargar";
                this.text_2.text = "Elige una opcion.";
                ...
                this.button_1.setText('Sin internet');
                this.button_2.setText('Por internet');
                this.button_1.y += this.box * 2;
                this.button_2.y += this.box * 2;
                ...
                this.text_1.text = "Subir";
                this.text_2.text = "Comparte tu nivel.";
                this.text_1.y = this.box * 6;
                this.text_2.y = this.box * 9;
                this.button_back = new Button("button_1", this.box*2, this.box*2, this.box*4, this.box*4, "#000000", "#000000", "#ffffff", "#ffffff"); //back button
                this.button_back.setText('_g');
                ...
                this.button_back.redraw();
                this.button_1.setText('Sin internet');
                this.button_2.setText('Con internet');
                this.button_1.y += this.box * 2;
                this.button_2.y += this.box * 2;
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_back, this.button_1, this.button_2);
            }
            else if (state == "playCode"){  //play code
                this.text_2.text = "Consigue un codigo de nivel e ingresalo aqui.";
                this.text_2.y = this.box * 8;
                ...
                this.text_1.text = "";
                this.text_2.text = "Espera 24 horas para hacerlo o añade mas.";
                this.text_1.y = this.box * 2;
                this.text_2.y = this.box * 4;
                this.button_1.setText('Añadir');
                this.button_2.setText('Cerrar');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_1, this.button_2); //exclude button_1
            }
            else if (state == "errorLevelLimit"){ //downloading dialog
                this.text_1.text = "";
                this.text_2.text = "Tu almacen de niveles esta lleno.";
                this.text_1.y = this.box * 2;
                this.text_2.y = this.box * 4;
                this.button_1.setText('Añade mas');
                this.button_2.setText('Cerrar');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_1, this.button_2); //exclude button_1
            }
            else if (state == "downloadSuccess"){ //download success dialog
                this.text_1.text = "Copia el codigo!";
                this.text_2.text = "Este es el codigo de tu nivel, no es permanente.";
                this.text_1.y = this.box * 4;
                this.text_2.y = this.box * 6;
                this.button_1.setText('Guardar');
                this.button_2.setText('Jugar');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_1, this.button_2); //exclude button_1
            }
            else if (state == "saveDownload"){ //save downloaded level dialog
                this.text_1.text = "Guardado!";
                this.text_2.text = "Puedes editar este nivel.";
                this.text_1.y = this.box * 4;
                this.text_2.y = this.box * 6;
                this.button_1.setText('Editar');
                this.button_2.setText('Jugar');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_1, this.button_2); //exclude button_1
            }
                ...
                this.text_2.text = "El codigo que ingresaste no existe.";
                this.text_1.y = this.box * 4;
                this.text_2.y = this.box * 6;
                this.button_1.setText('Cerrar');
                this.button_2.setText('Reintentar');
