	...
	function Home() {
        ...
        this.setTheme = function(selectedLevel){
            ...
            switch(Math.floor((selectedLevel)/this.rows)){
                ...
                case(1): updateUI = window.Game.theme.setTheme("jungleLand"); break;
                case(2): updateUI = window.Game.theme.setTheme("darkLand"); break;
                case(3): updateUI = window.Game.theme.setTheme("blueLand"); break;
                case(4): updateUI = window.Game.theme.setTheme("hellLand"); break;
        ...
        this.setUI = function(forceNextLevel){
            ...
            var mBox = this.box16*1.75;
            var topY = mBox*2, leftX = mBox*1.5;
            ...
            //adjust which level should be automatically be selected
