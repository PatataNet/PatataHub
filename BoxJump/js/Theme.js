	...
	function Theme() {
        ...
        this.setTheme = function(theme){
            ...
            if (theme != this.theme){ //only redraw if the theme is different
                ...
                else if (theme == "lightUniverse"){
                    //colors
                    this.layer1_color = "#ffffff"; //sky
                    this.layer2_color = "#ffffff"; //clouds
                    this.layer3_color = "#e2e2e2"; //landscape-1
                    this.layer4_color = "#cfcfcf"; //landscape-2
                    this.layer5_color = "#e2e2e2"; //landscape-3
                    this.layer6_color = "#ffffff"; //clouds
                    this.main_color1 = "#000000"; //player
                    this.main_color2 = "#c7c7c7"; //selector 1
                    this.main_color3 = "#b3b3b3"; //selector 2
                    this.main_color4 = "#000000"; //map tile
                    //layer 1
                    var bgColor = new createjs.Shape();
                    bgColor.graphics.beginFill(this.layer1_color).drawRect(0, -this.screenWidth, this.screenWidth*1.5, this.screenHeight*2);
                ...
                else if (theme == "voidWorld"){
                    //colors
                    this.layer1_color = "#000000"; //sky
                    this.layer2_color = "#0c0c0c"; //clouds
                    this.layer3_color = "#1a1a1a"; //landscape-1
                    this.layer4_color = "#343434"; //landscape-2
                    this.layer5_color = "#0c0c0c"; //landscape-3
                    this.layer6_color = "#ffffff"; //clouds
                    this.main_color1 = "#ffffff"; //player
                    this.main_color2 = "#000000"; //selector 1
                    this.main_color3 = "#1a1a1a"; //selector 2
                    this.main_color4 = "#252525"; //map tile
                    //layer 1
                    var bgColor = new createjs.Shape();
                    bgColor.graphics.beginFill(this.layer1_color).drawRect(0, -this.screenWidth, this.screenWidth*1.5, this.screenHeight*2);
                    layer1.addChild(bgColor);
		    ...
		    else if (theme == "Random world"){
                    //colors
                    this.layer1_color = "#E800FF"; //sky
                    this.layer2_color = "#00FF00"; //clouds
                    this.layer3_color = "#0027FF"; //landscape-1
                    this.layer4_color = "#FF0000"; //landscape-2
                    this.layer5_color = "#00FFE8"; //landscape-3
                    this.layer6_color = "#ffffff"; //clouds
                    this.main_color1 = "#ffffff"; //player
                    this.main_color2 = "#1FFF00"; //selector 1
                    this.main_color3 = "#FFF700"; //selector 2
                    this.main_color4 = "#876515"; //map tile
                    //layer 1
                    var bgColor = new createjs.Shape();
                    bgColor.graphics.beginFill(this.layer1_color).drawRect(0, -this.screenWidth, this.screenWidth*1.5, this.screenHeight*2);
                    layer1.addChild(bgColor);
