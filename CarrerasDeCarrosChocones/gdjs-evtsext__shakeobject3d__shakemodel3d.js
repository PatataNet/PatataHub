...
gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D = class ShakeModel3D extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData.Time = Number("0") || 0;
    this._behaviorData.Duration = Number("0") || 0;
    this._behaviorData.StartEasingDuration = Number("0") || 0;
    this._behaviorData.StopEasingDuration = Number("0") || 0;
    this._behaviorData.Frequency = behaviorData.Frequency !== undefined ? behaviorData.Frequency : Number("5") || 0;
    this._behaviorData.DeltaX = Number("0") || 0;
    this._behaviorData.DeltaY = Number("0") || 0;
    this._behaviorData.DeltaZ = Number("0") || 0;
    this._behaviorData.DeltaAngleX = Number("0") || 0;
    this._behaviorData.DeltaAngleY = Number("0") || 0;
    this._behaviorData.DeltaAngleZ = Number("0") || 0;
    this._behaviorData.NoiseTime = Number("123456789") || 0;
  }
  ...
  _getTime() {
    return this._behaviorData.Time !== undefined ? this._behaviorData.Time : Number("0") || 0;
  }
  _setTime(newValue) {
  ...
  _getStartEasingDuration() {
    return this._behaviorData.StartEasingDuration !== undefined ? this._behaviorData.StartEasingDuration : Number("0") || 0;
  }
  _setStartEasingDuration(newValue) {
    this._behaviorData.StartEasingDuration = newValue;
  }
  _getStopEasingDuration() {
    return this._behaviorData.StopEasingDuration !== undefined ? this._behaviorData.StopEasingDuration : Number("0") || 0;
  }
  _setStopEasingDuration(newValue) {
    this._behaviorData.StopEasingDuration = newValue;
  }
  _getFrequency() {
    return this._behaviorData.Frequency !== undefined ? this._behaviorData.Frequency : Number("5") || 0;
  }
  _setFrequency(newValue) {
    this._behaviorData.Frequency = newValue;
  }
  _getDeltaX() {
    return this._behaviorData.DeltaX !== undefined ? this._behaviorData.DeltaX : Number("0") || 0;
  }
  _setDeltaX(newValue) {
    this._behaviorData.DeltaX = newValue;
  }
  _getDeltaY() {
    return this._behaviorData.DeltaY !== undefined ? this._behaviorData.DeltaY : Number("0") || 0;
  }
  _setDeltaY(newValue) {
    this._behaviorData.DeltaY = newValue;
  }
  _getDeltaZ() {
    return this._behaviorData.DeltaZ !== undefined ? this._behaviorData.DeltaZ : Number("0") || 0;
  }
  _setDeltaZ(newValue) {
    this._behaviorData.DeltaZ = newValue;
  }
  _getDeltaAngleX() {
    return this._behaviorData.DeltaAngleX !== undefined ? this._behaviorData.DeltaAngleX : Number("0") || 0;
  }
  _setDeltaAngleX(newValue) {
    this._behaviorData.DeltaAngleX = newValue;
  }
  _getDeltaAngleY() {
    return this._behaviorData.DeltaAngleY !== undefined ? this._behaviorData.DeltaAngleY : Number("0") || 0;
  }
  _setDeltaAngleY(newValue) {
    this._behaviorData.DeltaAngleY = newValue;
  }
  _getDeltaAngleZ() {
    return this._behaviorData.DeltaAngleZ !== undefined ? this._behaviorData.DeltaAngleZ : Number("0") || 0;
  }
  _setDeltaAngleZ(newValue) {
    this._behaviorData.DeltaAngleZ = newValue;
  }
  _getNoiseTime() {
    return this._behaviorData.NoiseTime !== undefined ? this._behaviorData.NoiseTime : Number("123456789") || 0;
  }
...
gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StartEasingFactorContext.GDObjectObjects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StartEasingFactorContext.GDObjectObjects1 */
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = gdjs.evtTools.common.clamp((( gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StartEasingFactorContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StartEasingFactorContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getTime()) / (( gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StartEasingFactorContext.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StartEasingFactorContext.GDObjectObjects1[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getStartEasingDuration()), 0, 1); }}}
...
for (var i = 0, k = 0, l = gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StopEasingFactorContext.GDObjectObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StopEasingFactorContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getTime() < (gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.StopEasingFactorContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getDuration()) ) {
        isConditionTrue_0 = true;
