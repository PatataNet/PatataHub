...
gdjs.evtsExt__PlayingCard__SuiteId.conditionTrue_0 = {val:false};
gdjs.evtsExt__PlayingCard__SuiteId.condition0IsTrue_0 = {val:false};
...
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = Math.floor((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("CardId")) || 0 : 0) / 13); }}}
